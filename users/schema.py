...
#
#     @classmethod
#     def mutate(cls, root, info, username, first_name, last_name, is_staff, is_active, email):
#         user = User(username=username, first_name=first_name, last_name=last_name, is_staff=is_staff,
